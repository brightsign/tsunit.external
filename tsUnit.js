...
exports.FunctionPropertyHelper = exports.TestDescription = exports.TestDefinition = exports.FakeFactory = exports.TestClass = exports.TestContext = exports.TestRunLimiter = exports.Test = void 0;
var Test = (function () {
    function Test() {
        var testModules = [];
...
var FunctionPropertyHelper = (function () {
    ...
    FunctionPropertyHelper.walkImpl = function (obj, results) {
        ...
        ownPropertiesOfObj.forEach(function (mem) { return results.add(mem); });
        var prototype = Object.getPrototypeOf(obj);
        if (prototype == null) {
            return;
        }
        var propNames = Object.getOwnPropertyNames(prototype);
        propNames.forEach(function (mem) { return results.add(mem); });
